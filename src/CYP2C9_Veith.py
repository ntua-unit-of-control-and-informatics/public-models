...
benchmark, name = get_dataset('CYP2C9_Veith', group)
...
if args.run_as == 'single':
    ...
    if args.run_as == 'deploy':
        ...
        final_model.deploy_on_jaqpot(jaqpot=jaqpot,
                                     description="ADME model predicting the CYP2C9 (which play a major role in the oxidation of both xenobiotic and endogenous compounds) inhibition",
                                     model_title="CYP2C9 Inhibition Model")
